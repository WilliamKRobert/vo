...
void stereo_pose(Mat img1_l, Mat img1_r, Mat img2_l, vector<Point2f> &keypoints1_l, vector<Point2f> &keypoints2_l, Eigen::MatrixXf P1, Eigen::MatrixXf P2, Mat &R, Mat &t);
